...
console.log(`Even number array is ${evensArr}`)
...
//Let's write some code to check for that. Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, 
//log 'There are not enough elements in this array' to the console. If the length is more than 7, reassign the value of 'someNum' to the value of the 
//7th element in the array. (Hint: how can you make sure that your code works for exactly 7 elements? What index do you use to get the 7th element?)
...
}else //the last condition possible is when the length === 7
console.log(`There are 7 elements in the array. The 7th element of the array is ${myFavoriteNumbers[myFavoriteNumbers.length-1]}`);
